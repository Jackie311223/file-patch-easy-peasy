...
const InvoiceCreateModal: React.FC<InvoiceCreateModalProps> = ({
  ...
  const handleSelectAll = (eventOrChecked: React.ChangeEvent<HTMLInputElement> | boolean | 'indeterminate') => { 
    let isChecked = false;
    if (typeof eventOrChecked === 'boolean') {
        isChecked = eventOrChecked;
    } else if (typeof eventOrChecked === 'object' && eventOrChecked.target && typeof (eventOrChecked as React.ChangeEvent<HTMLInputElement>).target.checked === 'boolean') {
        isChecked = (eventOrChecked as React.ChangeEvent<HTMLInputElement>).target.checked;
    }
